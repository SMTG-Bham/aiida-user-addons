...
from .sgenodetail import SgeNoDetailScheduler, FeatureNotAvailable
import pytest
import uuid
import unittest
...
class TestSubmitScript(unittest.TestCase):
    ...
    def test_submit_script(self):
        ...
        job_tmpl.job_resource = scheduler.create_job_resource(num_machines=1, num_mpiprocs_per_machine=1, bigmem=True)
