...
class CASTEPInputSet(InputSet):
    ...
    def get_input_dict(self, raw_python=True, flat=True):
        ...
        out_dict = super(CASTEPInputSet, self).get_input_dict(raw_python=True)
    ...
    def get_settings(self):
        ...
        if 'spin_list' in self.overrides:
            if 'spin_mapping' not in self.overrides:
                ...
                raise ValueError('The spin cannot be defined in the overrides as both list and mappings.')
